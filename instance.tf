...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/rups04/hybridtask1.git /var/www/html/"
    ]
  }
}
...
resource "aws_s3_bucket_object" "object" {
  ...
  key        =  "rups.jpg"
  source   =  "C:/Users/LENOVO/Desktop/Terraform/s3_image/rupali.jpg"
  etag      =  filemd5("C:/Users/LENOVO/Desktop/Terraform/s3_image/rupali.jpg")
  acl        =  "public-read"
}
